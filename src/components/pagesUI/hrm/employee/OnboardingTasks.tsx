// OnboardingTasks.tsx - Fixed version
"use client";
...
const OnboardingTasks: React.FC<OnboardingTasksProps> = ({ employees }) => {
  ...
  const completionPercentage = (completedTasks / onboardingTasks.length) * 100;
      ...
      <CardContent>
        ...
        <List>
          {onboardingTasks.map((task) => (
            // ✅ FIX: Changed from ListItem with button prop to ListItemButton
            <ListItemButton
              key={task.id}
